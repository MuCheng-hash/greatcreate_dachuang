...
public class CatalogAdminController {
    ...
    @PostMapping("/entities/{entityType}/{entityId}/activate")
    public ApiResponse<CatalogEntityVO> activate(@PathVariable EntityType entityType,@PathVariable Long entityId){try{CatalogEntityVO item=catalogService.activate(entityType,entityId);projectionService.projectEntity(item);return ApiResponse.success("catalog entity activated",item);}catch(IllegalArgumentException ex){return ApiResponse.fail(ex.getMessage());}}
