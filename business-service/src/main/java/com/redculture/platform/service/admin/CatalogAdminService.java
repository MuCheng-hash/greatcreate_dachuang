...
public class CatalogAdminService {
    ...
    private Long insert(CatalogEntityRequest request) {
        ...
        return switch (type) {
            case RESOURCE -> { LocalEduResource item = new LocalEduResource(); apply(type, item, request); item.setReviewStatus(ReviewStatus.APPROVED); item.setActive(true); resourceMapper.insert(item); yield item.getResourceId(); }
            case SITE -> { RedSite item = new RedSite(); apply(type, item, request); item.setReviewStatus(ReviewStatus.APPROVED); item.setActive(true); siteMapper.insert(item); yield item.getSiteId(); }
            case MEMORIAL -> { MemorialHall item = new MemorialHall(); apply(type, item, request); item.setReviewStatus(ReviewStatus.APPROVED); item.setActive(true); memorialMapper.insert(item); yield item.getMemorialId(); }
    ...
    private CatalogEntityVO toVO(EntityType type, Object entity) {
        ...
        if(entity instanceof LocalEduResource x){vo.setEntityId(x.getResourceId());vo.setCode(x.getResourceCode());vo.setName(x.getResourceName());vo.setRegionId(x.getRegionId());vo.setAddress(x.getAddress());vo.setLongitude(x.getLongitude());vo.setLatitude(x.getLatitude());vo.setSummary(x.getIntro());vo.setDetail(x.getEducationValue());vo.setTargetGrade(x.getTargetGrade());vo.setResourceCategory(enumValue(x.getResourceCategory()));vo.setResourceSubcategory(x.getResourceSubcategory());vo.setOrganizationName(x.getOrganizationName());vo.setContactPhone(x.getContactPhone());vo.setOpeningTimeDesc(x.getOpeningTimeDesc());vo.setReservationRequired(x.getReservationRequired());vo.setRecommendedVisitMinutes(x.getRecommendedVisitMinutes());vo.setActivitySuggestion(x.getActivitySuggestion());vo.setSafetyNote(x.getSafetyNote());vo.setReviewStatus(enumValue(x.getReviewStatus()));vo.setActive(x.getActive());vo.setCreatedAt(x.getCreatedAt());vo.setUpdatedAt(x.getUpdatedAt());}
        else if(entity instanceof RedSite x){vo.setEntityId(x.getSiteId());vo.setCode(x.getSiteCode());vo.setName(x.getSiteName());vo.setRegionId(x.getRegionId());vo.setAddress(x.getAddress());vo.setLongitude(x.getLongitude());vo.setLatitude(x.getLatitude());vo.setSummary(x.getIntro());vo.setDetail(x.getHistoricalBackground());vo.setReviewStatus(enumValue(x.getReviewStatus()));vo.setActive(x.getActive());vo.setCreatedAt(x.getCreatedAt());vo.setUpdatedAt(x.getUpdatedAt());}
        ...
        else if(entity instanceof HeroPerson x){vo.setEntityId(x.getHeroId());vo.setCode(x.getHeroCode());vo.setName(x.getHeroName());vo.setRegionId(x.getNativePlaceRegionId());vo.setAddress(x.getNativePlaceText());vo.setSummary(x.getProfileSummary());vo.setDetail(x.getMainDeeds());vo.setReviewStatus(enumValue(x.getReviewStatus()));vo.setActive(x.getActive());vo.setCreatedAt(x.getCreatedAt());vo.setUpdatedAt(x.getUpdatedAt());}
        else if(entity instanceof HistoricalEvent x){vo.setEntityId(x.getEventId());vo.setCode(x.getEventCode());vo.setName(x.getEventName());vo.setRegionId(x.getPrimaryRegionId());vo.setLongitude(x.getLongitude());vo.setLatitude(x.getLatitude());vo.setSummary(x.getHistoricalSignificance());vo.setDetail(x.getEventProcess());vo.setReviewStatus(enumValue(x.getReviewStatus()));vo.setActive(x.getActive());vo.setCreatedAt(x.getCreatedAt());vo.setUpdatedAt(x.getUpdatedAt());}
